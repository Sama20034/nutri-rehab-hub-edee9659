                    ...
                    {paymentMethod !== 'cash_on_delivery' && (
                      ...
                      >
                        ...
                        <div className="p-3 sm:p-4 bg-secondary/10 border-2 border-secondary/30 rounded-xl">
                          <div className="flex items-start gap-3">
                            <div className="p-2 rounded-full bg-secondary/20 flex-shrink-0">
                            ...
                            <div className="flex-1">
                              <h4 className="font-bold text-foreground text-sm sm:text-base flex items-center gap-2">
                                ...
                                {isRTL ? 'مهم جداً!' : 'Very Important!'}
                              </h4>
                              <p className="text-xs sm:text-sm text-muted-foreground mt-1 leading-relaxed">
                                {isRTL 
                                  ? 'بعد تحويل المبلغ، يرجى عمل سكرين شوت (لقطة شاشة) للمعاملة وإرسالها عبر واتساب على الرقم 01016111733 مع ذكر رقم الطلب للتأكيد السريع ✅'
                                  : 'After transferring the amount, please take a screenshot of the transaction and send it via WhatsApp to 01016111733 with your order number for quick confirmation ✅'}
                              </p>
                              <a 
                                href="https://wa.me/201016111733" 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 mt-2 px-3 py-1.5 bg-[#25D366] text-white text-xs sm:text-sm font-medium rounded-lg hover:bg-[#20bd5a] transition-colors"
                              >
                                ...
                                {isRTL ? 'أرسل السكرين شوت' : 'Send Screenshot'}
                              </a>
                            </div>
                          </div>
                        </div>

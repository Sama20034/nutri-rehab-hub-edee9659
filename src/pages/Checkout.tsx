                        ...
                        <div className="p-3 sm:p-4 bg-secondary/10 border-2 border-secondary/30 rounded-xl">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs sm:text-sm text-muted-foreground mt-1 mb-3 leading-relaxed">
                                {isRTL 
                              ...
                              <div className="mt-3 pt-3 border-t border-secondary/20">
                                ...
                                <a 
                                  ...
                                  className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#25D366] text-white text-xs sm:text-sm font-medium rounded-lg hover:bg-[#20bd5a] transition-colors"
                                >

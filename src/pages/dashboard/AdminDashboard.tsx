...
import { HomepageVideoSection } from '@/components/admin/sections/HomepageVideoSection';
import { MissionImagesSection } from '@/components/admin/sections/MissionImagesSection';
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case 'pixel':
        return <PixelSection />;
      case 'mission-images':
        return <MissionImagesSection />;
      case 'homepage-video':
        return <HomepageVideoSection />;
      default:
        return null;
    }
  };

...
const sidebarItems = [
  ...
  { id: 'banners', labelAr: 'بانرات المتجر', labelEn: 'Store Banners', icon: Image },
  ...
  { id: 'health-profiles', labelAr: 'الملفات الصحية', labelEn: 'Health Profiles', icon: Heart },
  ...
  { id: 'mission-images', labelAr: 'صور رسالتنا', labelEn: 'Mission Images', icon: Image },
